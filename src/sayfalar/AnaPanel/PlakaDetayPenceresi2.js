...
import "./PlakaDetayPenceresi2.css";
import { fmt } from "./helpers";
import { PBadge } from "./ui";

function StatCard({ label, value, className = "", accent = "blue" }) {
    return (
        <div className={`dp-stat ${accent}`}>
    ...
    return (
        <div className="mini-card">
            <div className="mini-card-head">
                <div className="mini-card-kicker">Özet</div>
...
function PlateDetailPanel2({ plateNumber, allRows, onClose }) {
    const rows = useMemo(
    ...
    return (
        <div className="dp modal">
                ...
                <div className="dp-head-left">
                    ...
                    <div className="dp-title-row">
                        ...
                        <div className={`dp-profit-pill ${totalProfit >= 0 ? "pos" : "neg"}`}>
                            <span className="dp-profit-dot" />
                            {totalProfit >= 0 ? "Pozitif Bakiye" : "Negatif Bakiye"}
                        </div>
                    </div>
            ...
            <div className="dp-stats">
                <StatCard label="Toplam Alış" value={fmt(total.p, true)} accent="blue" />
                <StatCard label="Toplam Satış" value={fmt(total.s, true)} accent="teal" />
                <StatCard
                    label="Kâr / Zarar"
                ...
                />
                <StatCard label="Toplam İşlem" value={rows.length} accent="slate" />
            </div>
            ...
            <div className="dp-body">
                ...
                <div className="card details-card">
                    <div className="card-head">
                        <div>
                            <div className="card-kicker">Kayıtlar</div>
...
export default function PlateDetailModal2({ plateNumber, allRows, onClose }) {
