...
export default function Basbug() {
    ...
    return (
        <div className="basbug-page">
            <div className="basbug-header">
                <div>
                    <h1>Başbuğ Operasyon Ekranı</h1>
                    <p>
                        {yukleniyor
                            ? "Kayıtlar yükleniyor..."
                ...
                <div className="basbug-actions">
                    <label className="basbug-date-filter">
                    ...
                    <button className="basbug-add-button" onClick={yeniSatirEkle}>
                        + Yeni Değer Ekle
                    </button>

                    <button
                        className="basbug-save-button"
                        onClick={kaydet}
            ...
            <div className="basbug-card">
                <div className="basbug-table-wrapper">
                    <table className="basbug-table">
                        <thead>
                            <tr>
                                <th>#</th>
                                {kolonlar.map((kolon) => (
                        ...
                        <tbody>
                            {satirlar.map((satir, index) => (
                                <tr key={index}>
                                    <td className="basbug-row-number">{index + 1}</td>
                                    ...
                                    <td>
                                        <button
                                            className="basbug-delete-button"
